...
const createOrderItem = function(good) {
  ...
  if (good.classList.contains('product-info')) {
    ...
    if (goodTitle.textContent.includes('цыплёнок') || goodTitle.textContent.includes('Утка') || goodTitle.textContent.includes('Паштет') || goodTitle.textContent.includes('Джерки')){
